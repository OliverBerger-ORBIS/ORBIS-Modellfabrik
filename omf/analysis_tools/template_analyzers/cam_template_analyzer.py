#!/usr/bin/env python3
"""
CAM Template Analyzer

Spezifischer Analyzer für CAM Topics, die Base64-kodierte Bilddaten enthalten.
        ...
        for topic, analysis_data in results.items():
            ...
            observation = {
                ...
                "observation": {
                    ...
                    "topic": topic,
                    "description": f"CAM image data analysis for topic {topic}",
