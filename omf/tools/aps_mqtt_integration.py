...
class APSMqttIntegration:
    ...
    def _setup_aps_topics(self) -> Dict[str, List[str]]:
        ...
        return {
            "factsheet_topics": ["module/v1/ff/+/factsheet", "module/v1/ff/NodeRed/+/factsheet"],
            "state_topics": ["module/v1/ff/+/state", "module/v1/ff/NodeRed/+/state"],
            "order_topics": ["module/v1/ff/+/order", "module/v1/ff/NodeRed/+/order"],
            "instant_action_topics": ["module/v1/ff/+/instantAction", "module/v1/ff/NodeRed/+/instantAction"],
            "system_control_topics": ["ccu/set/+"],
            "fts_topics": ["fts/v1/ff/+/state", "fts/v1/ff/+/order", "fts/v1/ff/+/instantAction"],
        }
    ...
    def send_instant_action(
        self, action_type: str, parameters: Dict[str, Any] = None, target_module: str = None
    ) -> Dict[str, Any]:
    ...
    def publish_instant_action(self, action: Dict[str, Any], target_module: str = None) -> bool:
        ...
        try:
            ...
            if success:
                ...
                self.logger.error(
                    f"❌ Instant Action Publikation fehlgeschlagen: {action.get('actionType', 'UNKNOWN')}"
                )
