...
class VDA5050OrderManager:
    ...
    def create_storage_order(self, color: str, workpiece_id: str = None, target_module: str = None) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(f"📋 VDA5050 Order erstellt: {color} Werkstück {workpiece_id} " f"(Order: {order_id})")
            return vda_order
    ...
    def create_retrieval_order(self, color: str, workpiece_id: str = None, source_module: str = None) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(
                f"📋 VDA5050 Retrieval Order erstellt: {color} Werkstück {workpiece_id} " f"(Order: {order_id})"
            )
            return vda_order
    ...
    def process_order_response(self, response: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if order_id in self.active_orders:
                self.active_orders[order_id].update({"response": response, "last_updated": datetime.now().isoformat()})
    ...
    def complete_order(self, order_id: str, result: Dict[str, Any] = None) -> bool:
        ...
        try:
            ...
            order_info.update(
                {"status": "COMPLETED", "completed_at": datetime.now().isoformat(), "result": result or {}}
            )
