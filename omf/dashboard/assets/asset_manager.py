    ...
    def _load_product_templates(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "BLUE": {
                "name": "Produkt Blau",
                "color": "#0066ff",
                "description": "Workpiece, das gebohrt, gefräst und qualitätsgesichert wird.",
            ...
            "WHITE": {
                "name": "Produkt Weiß",
                "color": "#e0e0e0",
                "description": "Workpiece, das gebohrt und qualitätsgesichert wird.",
            ...
            "RED": {
                "name": "Produkt Rot",
                "color": "#ff0000",
                "description": "Workpiece, das gefräst und qualitätsgesichert wird.",
