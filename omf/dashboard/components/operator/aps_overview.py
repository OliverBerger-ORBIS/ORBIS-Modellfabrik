...
logger = get_logger("omf.dashboard.components.operator.aps_overview")
logger.info("🔍 LOADED: operator.aps_overview")
...
def _show_aps_bestellung_panel():
    ...
    try:
        ...
        from omf.dashboard.components.operator.overview_customer_order import show_overview_order
...
def _show_overview_order_with_aps_keys():
    ...
    from omf.dashboard.components.operator.aps_overview_customer_order import show_aps_overview_order
...
def _show_aps_rohware_panel():
    ...
    try:
        ...
        from omf.dashboard.components.operator.overview_purchase_order import show_overview_order_raw
...
def _show_overview_purchase_order_with_aps_keys():
    ...
    # Importiere die APS-Kopie der Komponente
    from omf.dashboard.components.operator.aps_overview_purchase_order import show_aps_overview_order_raw
...
def _show_aps_lagerbestand_panel():
    ...
    try:
        ...
        from omf.dashboard.components.operator.overview_inventory import show_overview_inventory
...
def _show_overview_inventory_with_aps_keys():
    ...
    # Importiere die APS-Kopie der Komponente
    from omf.dashboard.components.operator.aps_overview_inventory import show_aps_overview_inventory
