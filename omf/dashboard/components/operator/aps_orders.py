...
logger = get_logger("omf.dashboard.components.operator.aps_orders")
logger.info("🔍 LOADED: operator.aps_orders")
...
def _show_factory_layout_visualization():
    ...
    try:
        from omf.dashboard.components.operator.shopfloor_layout import show_shopfloor_grid
        show_shopfloor_grid()
    except ImportError:
