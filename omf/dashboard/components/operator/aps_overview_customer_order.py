...
def show_aps_overview_order():
    ...
    from omf.dashboard.components.operator.overview_customer_order import OrderManager
    ...
    if mqtt_client:
        ...
        try:
            ...
            if hbw_messages:
                ...
                from omf.dashboard.components.operator.overview_customer_order import process_customer_order_messages_from_buffers
