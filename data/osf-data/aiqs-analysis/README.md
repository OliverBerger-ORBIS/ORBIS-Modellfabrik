...
```bash
python scripts/analyze_aiqs_sessions.py data/osf-data/sessions/production_order_blue_20251110_180619.log
```

### Optionen
```bash
python scripts/analyze_aiqs_sessions.py <session_file> \
  --output-dir data/osf-data/aiqs-analysis \
  --session-name custom_name
```

### Alle Sessions analysieren
```bash
for log_file in data/osf-data/sessions/*.log; do
