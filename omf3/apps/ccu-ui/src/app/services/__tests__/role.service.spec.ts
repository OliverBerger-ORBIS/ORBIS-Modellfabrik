...
describe('RoleService', () => {
  ...
  describe('Initialization', () => {
    ...
    it('should persist role to localStorage and load it', () => {
      ...
      const stored = localStorage.getItem('omf3.user.role');
  ...
  describe('Role Validation', () => {
    ...
    it('should ignore invalid role in localStorage', () => {
      localStorage.setItem('omf3.user.role', 'invalid');
      const newService = TestBed.inject(RoleService);
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle null in localStorage', () => {
      localStorage.setItem('omf3.user.role', 'null');
      const newService = TestBed.inject(RoleService);
    ...
    it('should handle empty string in localStorage', () => {
      localStorage.setItem('omf3.user.role', '');
      const newService = TestBed.inject(RoleService);
    ...
    it('should handle number in localStorage', () => {
      localStorage.setItem('omf3.user.role', '123');
      const newService = TestBed.inject(RoleService);
    ...
    it('should handle boolean in localStorage', () => {
      localStorage.setItem('omf3.user.role', 'true');
      const newService = TestBed.inject(RoleService);
    ...
    it('should handle case-sensitive role validation', () => {
      localStorage.setItem('omf3.user.role', 'ADMIN');
      const newService = TestBed.inject(RoleService);
    ...
    it('should handle whitespace in localStorage', () => {
      localStorage.setItem('omf3.user.role', ' operator ');
      const newService = TestBed.inject(RoleService);
