...
import { FtsAnimationService, AnimationState } from '../fts-animation.service';
...
describe('FtsAnimationService', () => {
  let service: FtsAnimationService;
  let routeService: FtsRouteService;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [FtsAnimationService, FtsRouteService],
    });
    service = TestBed.inject(FtsAnimationService);
    routeService = TestBed.inject(FtsRouteService);
