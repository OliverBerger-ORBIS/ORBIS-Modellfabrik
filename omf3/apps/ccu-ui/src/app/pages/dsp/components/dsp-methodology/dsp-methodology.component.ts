...
export class DspMethodologyComponent {
  ...
  phases: Phase[] = [
    ...
    },
    {
      ...
      summary: $localize`:@@dspPhase3Summary:OEE, KPIs, Dashboards, Reporting`,
      activities: [
        $localize`:@@dspPhase3Activity1:Implement OEE calculation and monitoring`,
        $localize`:@@dspPhase3Activity2:Create real-time KPI dashboards`,
        $localize`:@@dspPhase3Activity3:Build reporting and analytics capabilities`,
        $localize`:@@dspPhase3Activity4:Enable data-driven decision making`,
      ],
