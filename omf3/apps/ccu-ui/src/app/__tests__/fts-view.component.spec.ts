...
describe('FtsViewComponent', () => {
  let component: FtsViewComponent;
  let fixture: ComponentFixture<FtsViewComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [FtsViewComponent],
    }).compileComponents();

    fixture = TestBed.createComponent(FtsViewComponent);
