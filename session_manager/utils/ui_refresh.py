"""
Thread-sichere UI-Refresh-Mechanismen für Session Manager
...
_FLAG = "_session_manager_ui_refresh_requested_at"
...
def consume_refresh() -> bool:
    """Früh in main() aufrufen. Gibt genau einmal True zurück, dann Flag löschen."""
