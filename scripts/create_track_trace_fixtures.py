...
def create_fixture(
    ...
    print(f"[{name}] Unique topics: {len({m.get('topic', '') for m in messages})}")
...
def main():
    ...
    data_dir = Path("data/osf-data/fts-analysis")
    ...
    sessions_dir = Path("data/osf-data/sessions")
    ...
    if storage_blue_files:
        ...
        create_fixture(
            name="storage_blue",
            fts_state_file=(
                data_dir / "storage_order_blue_20251110_181104_all_fts_messages.json"
                if (data_dir / "storage_order_blue_20251110_181104_all_fts_messages.json").exists()
                else None
            ),
            ccu_order_file=(
                data_dir / "storage_order_blue_20251110_181104_ccu_order.json"
                if (data_dir / "storage_order_blue_20251110_181104_ccu_order.json").exists()
                else None
            ),
            module_state_file=(
                data_dir / "storage_order_blue_20251110_181104_module_state.json"
                if (data_dir / "storage_order_blue_20251110_181104_module_state.json").exists()
                else None
            ),
        )
    else:
