...
- **Sprint 27:** Grafana-Dashboard-Analyse (Modus A, Panels, Persistenz) + Track&Trace **v1.2.0** auf RPi; Musashi **14.08.**; Hochschulkooperation Magdeburg — Teams-Vorstellung **03.08.** OK, Proposal folgt. Details: [sprint_27.md](sprints/sprint_27.md).
...
|--------|----------|------------------|--------|
| **27** | **24.07.26 - 06.08.26** | Grafana-Dashboard-Analyse & Track&Trace (v1.2.0); Musashi 14.08.; Hochschulkooperation Teams 03.08. ([sprint_27](sprints/sprint_27.md)) | **Laufend** |
...
| 27 | 24.07 - 06.08.2026 | ORBIS-SmartFactory | Phase 5 | Fokus Grafana-Dashboard-Analyse & Track&Trace (v1.2.0 RPi); Kundentermin Musashi (14.08.); Hochschulkooperation Magdeburg Teams-Vorstellung 03.08. (Proposal folgt: Graph-DB Edge/DSP/KI-Agenten); Carry-over Netzwerk/FTS/Blog A3–A4 |
