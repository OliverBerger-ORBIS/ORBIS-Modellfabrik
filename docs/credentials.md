...
- **Password**: `49117837`
- **Messe LogiMAT (2026-03):** SSID **`ORBIS-4C57`** (2.4 GHz für Arduino / Shopfloor am Messe-AP). Passwort wie oben, sofern gleiches Netz – **Arduino-Sketch:** `OSF_MultiSensor_R4WiFi` v1.1.2+.
