...
**Letzte Aktualisierung:** 2026-08-26 (Sprint 29, Intake/Refresh-Tests + Connection-Resubscribe)  
**Quelle:** `npm run test:coverage` → `coverage/osf-ui/index.html`  
**Tests:** 84 Suites passed / 2 skipped · 1464 passed / 16 skipped  
...
|--------|---------|----------------|----------|--------|
| **Lines** | **68.26 %** | 64 % ✅ | 60 %+ | Ziel erreicht |
| **Statements** | **67.15 %** | 63 % ✅ | ~60 % | Ziel erreicht |
| **Functions** | **63.34 %** | 59 % ✅ | ~60 % | Ziel erreicht |
| **Branches** | **51.69 %** | 48 % ✅ | 40 %+ | Ziel erreicht |

Trend: Sprint-28-Ende **66.5 / 49.8 / 61.3 / 65.5** (L/B/F/S) → 24.08. **67.8 / 51.2 / 62.8 / 66.7** → 26.08. **68.26 / 51.69 / 63.34 / 67.15**. Gates unverändert `48 / 59 / 64 / 63` (Margin ~3.7–4.3 pp).
