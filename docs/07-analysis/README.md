...
- **SOLL-Checklisten je Farbe (visueller Test / Agents):** [osf-ui-track-trace-soll-by-color.md](../04-howto/osf-ui-track-trace-soll-by-color.md) – WHITE/RED/BLUE Event-SOLL, MQTT-gaps, `ml-*`-Session-Lücken
