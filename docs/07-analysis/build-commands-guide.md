...
**Lösung:** Bereits umgesetzt (Phase 3, siehe [test-coverage-summary.md](test-coverage-summary.md)). Fixtures wurden aus Production Build entfernt.

### Problem 2: Default Configuration

**Aktuell:** `"defaultConfiguration": "production"`

**Bedeutung:** `nx build osf-ui` erstellt Production Build
