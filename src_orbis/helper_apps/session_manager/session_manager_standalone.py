#!/usr/bin/env python3
"""
Session Manager Dashboard - Standalone Version
...
from src_orbis.helper_apps.session_manager.logging_utils import get_session_logger
from src_orbis.helper_apps.session_manager.rerun_control import get_rerun_controller, request_rerun, execute_pending_rerun
...
class SessionManager:
    ...
    def increment_counter(self):
        ...
        # Logging
        self.logger.log_ui_action("counter_increment", {
            "old_value": old_value,
            "new_value": new_value
        })
        ...
        st.session_state.session_data["actions_log"].append({
...
def render_log_file_viewer():
    ...
    try:
        ...
        with open(log_file, 'rb') as f:
            st.download_button(
                "📥 Vollständige Log-Datei herunterladen",
                f.read(),
                file_name="session_manager.log",
                mime="text/plain"
            )
