...
def display_category_templates(templates: Dict[str, Any]):
    ...
    selected_template = st.selectbox(
        ...
        key=f"template_select_{id(templates)}"
    )
...
def copy_template_to_observations(template_name: str, template_info: Dict[str, Any]):
    ...
    try:
        ...
        st.info("💡 **Hinweis:** Template wurde nach `data/observations/generated_templates/` exportiert. Manuell nach `registry/model/v1/templates/` kopieren.")
