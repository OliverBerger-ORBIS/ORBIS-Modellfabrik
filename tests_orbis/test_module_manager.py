...
class TestModuleManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_config = {
            ...
            'module_types': ['Processing', 'Quality-Control', 'Storage', 'Input/Output', 'Charging', 'Transport'],
            'commands': ['PICK', 'DROP', 'STORE', 'MILL', 'DRILL', 'CHECK_QUALITY', 'NAVIGATE'],
    ...
    def test_get_all_modules(self):
        ...
        expected_ids = ['SVR3QA0022', 'SVR4H76449', 'SVR4H76530', 'SVR4H73275', 'CHRG0', '5iO4']
    ...
    def test_get_module_types(self):
        ...
        expected_types = ['Processing', 'Quality-Control', 'Storage', 'Input/Output', 'Charging', 'Transport']
        self.assertEqual(types, expected_types)
    
    def test_get_commands(self):
        """Test getting all available commands"""
        commands = self.manager.get_commands()
        expected_commands = ['PICK', 'DROP', 'STORE', 'MILL', 'DRILL', 'CHECK_QUALITY', 'NAVIGATE']
        self.assertEqual(commands, expected_commands)
...
class TestModuleManagerBackwardCompatibility(unittest.TestCase):
    ...
    def test_backward_compatibility_functions(self):
        ...
        from mqtt.tools.module_manager import (
            get_module_info, get_module_name, get_module_type, validate_module_id
        )
