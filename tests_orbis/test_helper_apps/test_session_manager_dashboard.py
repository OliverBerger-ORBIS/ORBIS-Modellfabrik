#!/usr/bin/env python3
"""
Tests für Session Manager Dashboard
"""
...
from src_orbis.helper_apps.session_manager.session_manager_dashboard import setup_logging
...
class TestSessionManagerIntegration(unittest.TestCase):
    ...
    def test_log_directory_creation(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('src_orbis.helper_apps.session_manager.session_manager_dashboard.Path') as mock_path_class:
