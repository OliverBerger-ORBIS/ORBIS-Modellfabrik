...
class TestNodeRedTemplateAnalyzer(unittest.TestCase):
    ...
    def test_get_placeholder_for_field(self):
        ...
        test_cases = [
            ...
            ("description", {"desc1", "desc2", "desc3", "desc4", "desc5", "desc6"}, "<string>")
        ]
    ...
    def test_analyze_topic_structure_from_sessions(self):
        ...
        # Insert test data
        test_messages = [
            ("ccu/state/flows", '{"status": "online", "timestamp": "2024-01-01T12:00:00Z"}', "2024-01-01T12:00:00Z"),
            ("ccu/state/flows", '{"status": "offline", "timestamp": "2024-01-01T13:00:00Z"}', "2024-01-01T13:00:00Z")
        ]
    ...
    def test_analyze_all_topics(self):
        ...
        test_messages = [
            ("ccu/state/flows", '{"status": "online", "flow_count": 5}', "2024-01-01T12:00:00Z"),
            ("module/v1/ff/NodeRed/SVR4H73275/connection", '{"connected": true, "module_id": "SVR4H73275"}', "2024-01-01T12:00:00Z"),
            ("module/v1/ff/NodeRed/SVR4H76530/state", '{"status": "idle", "module_id": "SVR4H76530"}', "2024-01-01T12:00:00Z")
        ]
    ...
    def test_save_results(self):
        ...
        test_results = {
            "test/topic": {
                ...
                "statistics": {"total_messages": 1, "enum_fields": 1, "variable_fields": 0}
            }
        }
...
class TestNodeRedTemplateAnalyzerIntegration(unittest.TestCase):
    ...
    def test_full_analysis_workflow(self):
        ...
        test_messages = [
            # CCU topics
            ("ccu/state/flows", '{"status": "online", "flow_count": 5, "timestamp": "2024-01-01T12:00:00Z"}', "2024-01-01T12:00:00Z"),
            ("ccu/state/dashboard", '{"status": "active", "dashboard_count": 3, "timestamp": "2024-01-01T12:00:00Z"}', "2024-01-01T12:00:00Z"),
            ("ccu/state/ui", '{"status": "ready", "ui_count": 2, "timestamp": "2024-01-01T12:00:00Z"}', "2024-01-01T12:00:00Z"),
            
            # Node-RED module topics
            ("module/v1/ff/NodeRed/SVR4H73275/connection", '{"connected": true, "module_id": "SVR4H73275", "timestamp": "2024-01-01T12:00:00Z"}', "2024-01-01T12:00:00Z"),
            ("module/v1/ff/NodeRed/SVR4H73275/state", '{"status": "idle", "module_id": "SVR4H73275", "timestamp": "2024-01-01T12:00:00Z"}', "2024-01-01T12:00:00Z"),
            ("module/v1/ff/NodeRed/SVR4H73275/order", '{"order_id": "ORD001", "status": "pending", "module_id": "SVR4H73275"}', "2024-01-01T12:00:00Z"),
            ("module/v1/ff/NodeRed/SVR4H73275/factsheet", '{"module_id": "SVR4H73275", "type": "DPS", "description": "Warenein- und Ausgang"}', "2024-01-01T12:00:00Z"),
            ("module/v1/ff/NodeRed/SVR4H73275/instantAction", '{"action": "reset", "module_id": "SVR4H73275"}', "2024-01-01T12:00:00Z"),
            
            ("module/v1/ff/NodeRed/SVR4H76530/connection", '{"connected": true, "module_id": "SVR4H76530", "timestamp": "2024-01-01T12:00:00Z"}', "2024-01-01T12:00:00Z"),
            ("module/v1/ff/NodeRed/SVR4H76530/state", '{"status": "processing", "module_id": "SVR4H76530", "timestamp": "2024-01-01T12:00:00Z"}', "2024-01-01T12:00:00Z"),
            
            # Node-RED status
            ("module/v1/ff/NodeRed/status", '{"overall_status": "healthy", "active_modules": 5, "timestamp": "2024-01-01T12:00:00Z"}', "2024-01-01T12:00:00Z"),
            
            # Flow topics
            ("flows/default/status", '{"flow_status": "running", "node_count": 10, "timestamp": "2024-01-01T12:00:00Z"}', "2024-01-01T12:00:00Z"),
            ("flows/default/config", '{"flow_config": "active", "version": "1.0", "timestamp": "2024-01-01T12:00:00Z"}', "2024-01-01T12:00:00Z"),
            
            # Dashboard topics
            ("dashboard/default/status", '{"dashboard_status": "active", "widget_count": 5, "timestamp": "2024-01-01T12:00:00Z"}', "2024-01-01T12:00:00Z"),
            ("dashboard/default/config", '{"dashboard_config": "default", "theme": "light", "timestamp": "2024-01-01T12:00:00Z"}', "2024-01-01T12:00:00Z"),
            
            # UI topics
            ("ui/default/status", '{"ui_status": "ready", "component_count": 3, "timestamp": "2024-01-01T12:00:00Z"}', "2024-01-01T12:00:00Z"),
            ("ui/default/config", '{"ui_config": "default", "layout": "grid", "timestamp": "2024-01-01T12:00:00Z"}', "2024-01-01T12:00:00Z")
        ]
