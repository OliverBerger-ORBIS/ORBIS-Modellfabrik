...
class TestDatabaseStructure(unittest.TestCase):
    ...
    def test_default_database_structure(self):
        ...
        try:
            ...
            self.assertEqual(len(missing_columns), 0, f"Fehlende Spalten: {missing_columns}")
    ...
    def test_database_loading_in_dashboard(self):
        ...
        try:
            ...
            self.assertEqual(len(missing_columns), 0, f"Fehlende Spalten im DataFrame: {missing_columns}")
    ...
    def test_session_label_extraction(self):
        ...
        try:
            ...
            self.assertFalse(df['session_label'].isna().all(), "session_label ist komplett leer")
