...
TXT_M_I1_photo_transistor = txt_factory.input_factory.create_photo_transistor(TXT_M, 1)
...
TXT_M_I7_ultrasonic_distance_meter = txt_factory.input_factory.create_ultrasonic_distance_meter(TXT_M, 7)
TXT_M_I8_ultrasonic_distance_meter = txt_factory.input_factory.create_ultrasonic_distance_meter(TXT_M, 8)
TXT_M_I5_trail_follower = txt_factory.input_factory.create_trail_follower(TXT_M, 5)
TXT_M_I6_trail_follower = txt_factory.input_factory.create_trail_follower(TXT_M, 6)
