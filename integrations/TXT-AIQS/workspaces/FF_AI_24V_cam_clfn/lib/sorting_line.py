...
def publish_quality_check_image(result, num, classification, classificationDesc):
  ...
  """
  Publiziert das zuletzt gespeicherte AIQS-Bild als Base64 (data URL) zusammen mit
    Result/Num und Klassifizierung (Enumeration + Beschreibung).
...
def set_status(status):
  global result, num, classification, classificationDesc, action, parameter, default_value, success, unexpected, result_code, ACTION_PICK, STATE_IDLE, _unused, has_order, ACTION_DROP, STATE_PICKING, controllerid, current_status, ACTION_PROCESS, STATE_IDLE_WITH_STOCK, STATE_RESET, RESULT_PASSED, STATE_FAILED, STATE_PROCESSING, RESULT_FAILED, STATE_PICKING_DONE, actionCommand, MovementSpeed, STATE_PROCESSING_IDLE, PositionPASSED, PositionFAILED, PositionCamera, dubblepart
...
def complete_vda_action(success):
  global result, num, classification, classificationDesc, action, parameter, default_value, status, unexpected, result_code, ACTION_PICK, STATE_IDLE, _unused, has_order, ACTION_DROP, STATE_PICKING, controllerid, current_status, ACTION_PROCESS, STATE_IDLE_WITH_STOCK, STATE_RESET, RESULT_PASSED, STATE_FAILED, STATE_PROCESSING, RESULT_FAILED, STATE_PICKING_DONE, actionCommand, MovementSpeed, STATE_PROCESSING_IDLE, PositionPASSED, PositionFAILED, PositionCamera, dubblepart
  action = vda_get_action()
  if not action:
    return
  if success:
...
def handle_mqtt_disconnected(unexpected):
  global result, num, classification, classificationDesc, action, parameter, default_value, status, success, result_code, ACTION_PICK, STATE_IDLE, _unused, has_order, ACTION_DROP, STATE_PICKING, controllerid, current_status, ACTION_PROCESS, STATE_IDLE_WITH_STOCK, STATE_RESET, RESULT_PASSED, STATE_FAILED, STATE_PROCESSING, RESULT_FAILED, STATE_PICKING_DONE, actionCommand, MovementSpeed, STATE_PROCESSING_IDLE, PositionPASSED, PositionFAILED, PositionCamera, dubblepart
...
def get_metadata_parameter(action, parameter, default_value):
  global result, num, classification, classificationDesc, status, success, unexpected, result_code, ACTION_PICK, STATE_IDLE, _unused, has_order, ACTION_DROP, STATE_PICKING, controllerid, current_status, ACTION_PROCESS, STATE_IDLE_WITH_STOCK, STATE_RESET, RESULT_PASSED, STATE_FAILED, STATE_PROCESSING, RESULT_FAILED, STATE_PICKING_DONE, actionCommand, MovementSpeed, STATE_PROCESSING_IDLE, PositionPASSED, PositionFAILED, PositionCamera, dubblepart
  try:
...
def handle_mqtt_connected(result_code):
  global result, num, classification, classificationDesc, action, parameter, default_value, status, success, unexpected, ACTION_PICK, STATE_IDLE, _unused, has_order, ACTION_DROP, STATE_PICKING, controllerid, current_status, ACTION_PROCESS, STATE_IDLE_WITH_STOCK, STATE_RESET, RESULT_PASSED, STATE_FAILED, STATE_PROCESSING, RESULT_FAILED, STATE_PICKING_DONE, actionCommand, MovementSpeed, STATE_PROCESSING_IDLE, PositionPASSED, PositionFAILED, PositionCamera, dubblepart
