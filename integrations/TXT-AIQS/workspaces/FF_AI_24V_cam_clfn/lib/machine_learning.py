...
def reset_inteface():
  global tag, value, num, key, keytext, color, ts, filename, sat, hue, duration, prob, pos, frame, detector, result
...
def containInHTML(tag, value):
  global num, key, keytext, color, ts, filename, sat, hue, duration, prob, pos, frame, detector, result
