...
describe('Topic matching', () => {
    it('should match the single level wildcard topics', () => {
        ...
        expect((0, helpers_1.matchTopics)(subscribeSingleLevelWildCard, topicSingleLevelWildCard)).toBe(true);
    });
    it('should match the single level wildcard topics with multiple subscribed topics', () => {
        ...
        expect((0, helpers_1.matchTopics)([subscribeSingleLevelWildCard, subscribeSingleLevelWildCard2], topicSingleLevelWildCard)).toBe(true);
    });
    ...
    it('should not match single level wildcard with single subscription', () => {
        ...
        expect((0, helpers_1.matchTopics)(subscribeSingleLevelWildCard, topicSingleLevelWildCard)).toBe(false);
    });
    it('should not match the single level wildcard topics with multiple subscribed topics', () => {
        ...
        expect((0, helpers_1.matchTopics)([subscribeSingleLevelWildCard, subscribeSingleLevelWildCard2], topicSingleLevelWildCard)).toBe(false);
    });
