...
const moduleDPS = { type: ModuleType.DPS, serialNumber: 'kBix' };
const moduleHBW = { type: ModuleType.HBW, serialNumber: 'yBix' };
const moduleAIQS = { type: ModuleType.AIQS, serialNumber: '4Cjx' };
const moduleMILL = { type: ModuleType.MILL, serialNumber: 'ctxw' };
const moduleDRILL = { type: ModuleType.DRILL, serialNumber: 'xULx' };

export const office_modules: Module[] = [moduleDPS, moduleHBW, moduleAIQS, moduleMILL, moduleDRILL];
...
export const office_intersections: FactoryNode[] = [
  intersection1,
  intersection2,
  intersection3,
  intersection4,
...
export const office_edges: FactoryRoad[] = [edge1, edge2, edge3, edge4, edge5, edge6, edge7, edge8, edge9, edge11, edge12];

export const EXPECTED_OFFICE_GRAPH = {
  nodes: [
    {
      id: 'kBix',
      module: {
...
export const EXPECTED_ROUTE_DPS_MILL = {
