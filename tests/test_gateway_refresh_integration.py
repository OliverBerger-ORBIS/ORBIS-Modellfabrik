...
def mock_gateway():
    ...
    with patch("omf2.ccu.ccu_gateway.get_registry_manager") as mock_reg_mgr, patch(
        "omf2.ccu.ccu_gateway.get_ccu_message_manager"
    ) as mock_msg_mgr, patch("omf2.ccu.ccu_gateway.get_ccu_topic_manager") as mock_topic_mgr, patch(
        "omf2.ccu.ccu_gateway.get_monitor_manager"
    ) as mock_mon_mgr:
