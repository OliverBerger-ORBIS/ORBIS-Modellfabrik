...
def test_get_last_refresh_timestamp_success():
    ...
    mock_response.json.return_value = {"success": True, "group": "test_group", "timestamp": 1234567890.123}
...
def test_get_last_refresh_timestamp_no_timestamp():
    ...
    mock_response = Mock()
    mock_response.status_code = 200
    mock_response.json.return_value = {"success": True, "group": "test_group", "timestamp": None}
...
def test_should_reload_data_no_previous_timestamp():
    ...
    with patch("omf2.ui.common.refresh_polling.st", mock_st), patch(
        "omf2.ui.common.refresh_polling.get_last_refresh_timestamp", return_value=1234567890.0
    ):
...
def test_should_reload_data_with_newer_timestamp():
    ...
    with patch("omf2.ui.common.refresh_polling.st", mock_st), patch(
        "omf2.ui.common.refresh_polling.get_last_refresh_timestamp", return_value=2000.0
    ):
...
def test_should_reload_data_api_unavailable():
    ...
    with patch("omf2.ui.common.refresh_polling.st", mock_st), patch(
        "omf2.ui.common.refresh_polling.get_last_refresh_timestamp", return_value=None
    ):
