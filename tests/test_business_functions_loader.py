        ...
        self.test_config = {
            ...
            "business_functions": {
                "test_manager": {
                    ...
                    "priority": 5,
                    "metadata": {"category": "test", "requires_mqtt": True},
                },
                "disabled_manager": {
                    "enabled": False,
            ...
            "qos_settings": {"default_qos": 1, "critical_topics": ["test/critical"], "qos": 2},
            "routing": {"enable_wildcard_matching": True, "topic_separator": "/"},
            "validation": {"require_module_path": True, "require_class_name": True, "allow_disabled_functions": True},
        }
...
class TestBusinessFunctionsLoaderHelpers:
    ...
    def setup_method(self):
        ...
        self.test_config = {
            "metadata": {"version": "1.0.0", "last_updated": "2025-10-25", "author": "Test", "description": "Test"},
            "business_functions": {
                "test_func": {
                    "enabled": True,
                    "description": "Test",
...
class TestBusinessFunctionsValidation:
    ...
    def test_missing_metadata_field(self):
        ...
        invalid_config = {
            ...
            "business_functions": {
                "test": {"enabled": True, "description": "Test", "module_path": "test", "class_name": "Test"}
            },
        }
