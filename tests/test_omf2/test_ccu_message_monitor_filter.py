...
class TestCCUMessageMonitorFilter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_buffers = {
            "module/v1/ff/SVR3QA0022/state": deque([{"mqtt_timestamp": 1234567890, "payload": {"state": "AVAILABLE"}}]),
            "module/v1/ff/SVR3QA0022/connection": deque(
                [{"mqtt_timestamp": 1234567890, "payload": {"connected": True}}]
            ),
            "module/v1/ff/SVR4H76449/state": deque([{"mqtt_timestamp": 1234567890, "payload": {"state": "BUSY"}}]),
            "module/v1/ff/5iO4/state": deque([{"mqtt_timestamp": 1234567890, "payload": {"state": "READY"}}]),
            "ccu/pairing/state": deque([{"mqtt_timestamp": 1234567890, "payload": {"modules": []}}]),
        }
    ...
    def test_apply_message_filters_specific_module(self):
        ...
        with patch(
            ...
            hbw_topics = ["module/v1/ff/SVR3QA0022/state", "module/v1/ff/SVR3QA0022/connection"]
    ...
    def test_apply_message_filters_combined_filters(self):
        ...
        with patch(
            ...
            self.assertNotIn(
                "module/v1/ff/SVR3QA0022/connection", result, "Connection Topic sollte nicht im Filter-Result sein"
            )
...
class TestCCUMessageMonitorFilterIntegration(unittest.TestCase):
    ...
    def test_filter_performance(self):
        ...
        for i in range(100):
            ...
            large_buffers[topic] = deque([{"mqtt_timestamp": 1234567890, "payload": {"state": "AVAILABLE"}}])
