...
from omf2.factory.gateway_factory import get_admin_gateway, get_ccu_gateway, get_gateway_factory, get_nodered_gateway
...
class TestComprehensiveArchitecture(unittest.TestCase):
    ...
    def test_gateway_factory_management(self):
        ...
        factory.get_ccu_gateway()
        factory.get_nodered_gateway()
        factory.get_admin_gateway()
