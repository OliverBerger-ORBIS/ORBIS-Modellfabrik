...
class TestModuleDetailsIntegration:
    ...
    def test_show_module_info_with_factsheet(self):
        ...
        # Test data
        module_status = {"connected": True, "available": "READY", "message_count": 5, "last_update": "12:34:56"}

        factsheet_status = {
            "factsheet_data": {"name": "MILL Module", "version": "1.0", "serialNumber": "SVR4H73275"},
            "configured": True,
        }
    ...
    def test_show_module_info_without_factsheet(self):
        ...
        module_status = {"connected": False, "available": "Unknown", "message_count": 0, "last_update": "Never"}
