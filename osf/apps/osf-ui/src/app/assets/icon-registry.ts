...
export const ICON_MAP: Record<IconKey, string> = {
  ...
  'edge-connectivity': 'assets/svg/dsp/functions/edge-connectivity.svg',
  'edge-digital-twin': 'assets/svg/dsp/functions/edge-digital-twin.svg',
  'edge-data-storage': 'assets/svg/dsp/functions/edge-data-storage.svg',
  'edge-analytics': 'assets/svg/dsp/functions/edge-analytics.svg',
  'edge-network': 'assets/svg/dsp/functions/edge-connectivity.svg',
  ...
  'txt-controller': 'assets/svg/shopfloor/stations/txt-controller.svg',
};
