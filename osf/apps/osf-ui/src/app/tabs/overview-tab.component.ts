...
import type { FtsState, OrderActive, InventoryOverviewState, InventorySlotState, StockSnapshot } from '@osf/entities';
...
@Component({
  ...
  imports: [CommonModule, OrdersViewComponent, AgvViewComponent],
