...
export class Uc00I18nService {
  ...
  private getEnglishTranslations(): Record<string, string> {
    return {
      ...
      'uc00.step.normalize.description': 'Canonize events across protocols and data models',
      'uc00.step.enrich.titleLine1': 'Enrich context,',
      'uc00.step.enrich.titleLine2': '(order, workpiece, station, time)',
      'uc00.step.enrich.description': 'Link events to process context',
      'uc00.step.correlate.titleLine1': 'Correlate,',
      'uc00.step.correlate.titleLine2': '(event chain → process step)',
      'uc00.step.correlate.description': 'Map event chains to interpretable steps',
