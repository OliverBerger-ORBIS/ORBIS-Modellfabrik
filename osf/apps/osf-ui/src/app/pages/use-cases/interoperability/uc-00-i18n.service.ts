...
export class Uc00I18nService {
  ...
  private getEnglishTranslations(): Record<string, string> {
    return {
      ...
      'uc00.outcome.traceability': 'Traceability / genealogy',
      'uc00.outcome.kpi': 'KPI calculation (lead time, downtime, OEE building blocks)',
      'uc00.outcome.kpi.line1': 'KPI calculation',
      'uc00.outcome.kpi.line2': '(lead time, downtime, OEE building blocks)',
      'uc00.outcome.closed_loop': 'Closed-loop orchestration',
