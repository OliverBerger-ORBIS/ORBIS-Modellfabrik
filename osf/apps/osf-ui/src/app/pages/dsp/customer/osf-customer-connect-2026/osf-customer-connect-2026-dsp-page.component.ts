...
@Component({
  standalone: true,
  selector: 'app-osf-customer-connect-2026-dsp-page',
  ...
  template: `
    <div class="customer-dsp-page">
      <header class="customer-header">
        ...
        <p class="subtitle">Full functional sequence for Customer Connect.</p>
...
export class OsfCustomerConnect2026DspPageComponent implements OnInit {
