...
describe('MessageMonitorService', () => {
  ...
  describe('persistence', () => {
    it('should persist messages to localStorage', () => {
      ...
      const key = 'OSF.message-monitor.test/topic';
    ...
    it('should not persist camera data', () => {
      ...
      const key = 'OSF.message-monitor./j1/txt/1/i/cam';
      const stored = localStorage.getItem(key);
    ...
    it('should handle corrupted persisted data gracefully', () => {
      ...
      const key = 'OSF.message-monitor.test/corrupted';
    ...
    it('should handle invalid JSON in persisted data', () => {
      ...
      const key = 'OSF.message-monitor.test/invalid-json';
