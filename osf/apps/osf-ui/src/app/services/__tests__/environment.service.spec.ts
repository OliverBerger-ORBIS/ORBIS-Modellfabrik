...
describe('EnvironmentService', () => {
  ...
  describe('Environment Management', () => {
    ...
    it('should persist environment to localStorage', () => {
      ...
      const stored = localStorage.getItem('OSF.environment');
  ...
  describe('Connection Storage', () => {
    ...
    it('should persist connection settings to localStorage', () => {
      ...
      const stored = localStorage.getItem('OSF.environment.connections');
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle corrupted connection storage gracefully', () => {
      localStorage.setItem('OSF.environment.connections', 'invalid json{{{');
    ...
    it('should handle partial connection storage', () => {
      ...
      localStorage.setItem('OSF.environment.connections', JSON.stringify(partialData));
    ...
    it('should migrate port 1883 to 9001 for replay', () => {
      ...
      localStorage.setItem('OSF.environment.connections', JSON.stringify(oldConnections));
