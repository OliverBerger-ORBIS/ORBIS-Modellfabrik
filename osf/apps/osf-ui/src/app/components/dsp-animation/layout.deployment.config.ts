...
export function createDeploymentView(customerConfig?: import('./configs/types').CustomerDspConfig): DiagramConfig {
  ...
  const steps: StepConfig[] = [
    ...
    // Step 5: Provisioning (with highlight)
    {
    ...
    // Step 6: Full overview - everything visible, nothing highlighted
    {
      id: 'deployment-step-6',
      label: $localize`:@@dspDeployStepFull:DSP Deployment Pipeline`,
