  ...
  // HBW (High-Bay Warehouse) - Storage operations sequence
  {
    ...
    payload: JSON.stringify({
      ...
      actionState: {
        ...
        command: 'PICK',
        state: 'FINISHED',
        timestamp: utcIsoTimestampMs(new Date(Date.now() - 50000)),
        result: 'PASSED',
        metadata: {
          slot: 'A1',
          level: '2',
  ...
  },
  {
    ...
    payload: JSON.stringify({
      ...
      actionState: {
        ...
        command: 'DROP',
        state: 'RUNNING',
        timestamp: utcIsoTimestampMs(new Date(Date.now() - 40000)),
        metadata: {
          slot: 'B3',
          level: '1',
  ...
  },
  {
    ...
    payload: JSON.stringify({
      ...
      actionState: {
        ...
        command: 'DROP',
        state: 'FINISHED',
        timestamp: utcIsoTimestampMs(new Date(Date.now() - 30000)),
        result: 'PASSED',
        metadata: {
          slot: 'B3',
          level: '1',
  ...
  },
  {
    ...
    payload: JSON.stringify({
      ...
      actionState: {
        ...
        command: 'PICK',
        state: 'FINISHED',
        timestamp: utcIsoTimestampMs(new Date(Date.now() - 20000)),
        result: 'PASSED',
        metadata: {
          slot: 'C2',
          level: '3',
  ...
  // DRILL - Drilling operations sequence
  {
    ...
    payload: JSON.stringify({
      ...
      actionState: {
        ...
        command: 'PICK',
        state: 'FINISHED',
        timestamp: utcIsoTimestampMs(new Date(Date.now() - 55000)),
        result: 'PASSED',
        metadata: {
  ...
  },
  {
    ...
    payload: JSON.stringify({
      ...
      actionState: {
        ...
        command: 'DRILL',
        state: 'RUNNING',
        timestamp: utcIsoTimestampMs(new Date(Date.now() - 45000)),
        metadata: {
          drillDepth: 15,
          drillSpeed: 1200,
          workpieceId: 'WP-DRILL-001',
  ...
  },
  {
    ...
    payload: JSON.stringify({
      ...
      actionState: {
        ...
        command: 'DRILL',
        state: 'FINISHED',
        timestamp: utcIsoTimestampMs(new Date(Date.now() - 35000)),
        result: 'PASSED',
        metadata: {
          drillDepth: 15,
          drillSpeed: 1200,
  ...
  },
  {
    ...
    payload: JSON.stringify({
      ...
      actionState: {
        ...
        command: 'DROP',
        state: 'FINISHED',
        timestamp: utcIsoTimestampMs(new Date(Date.now() - 25000)),
        result: 'PASSED',
        metadata: {
          workpieceId: 'WP-DRILL-001',
        },
  ...
  // MILL - Milling operations sequence
  {
    ...
    payload: JSON.stringify({
      ...
      actionState: {
        ...
        command: 'PICK',
        state: 'FINISHED',
        timestamp: utcIsoTimestampMs(new Date(Date.now() - 60000)),
        result: 'PASSED',
        metadata: {
  ...
  // AIQS - Quality inspection sequence
  {
    ...
    payload: JSON.stringify({
      ...
      actionState: {
        ...
        state: 'RUNNING',
        timestamp: utcIsoTimestampMs(new Date(Date.now() - 15000)),
        metadata: {
