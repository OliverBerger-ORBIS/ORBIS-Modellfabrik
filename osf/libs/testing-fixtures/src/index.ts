...
const FIXTURE_PATHS: Record<OrderFixtureName, string> = {
  ...
  storage_blue_agv2: 'storage_blue_agv2/storage_blue_agv2.log',
  storage_blue_parallel: 'storage_blue_parallel/storage_blue_parallel.log',
  'track-trace-production-bwr': 'track-trace/track-trace-production-bwr.log',
  production_blue_dual_agv_step15:
    'production_blue_dual_agv_step15/production_blue_dual_agv_step15.log',
};
...
export const SHOPFLOOR_ASSET_MAP: Record<string, string> = {
  ...
  OVEN: 'assets/svg/shopfloor/stations/oven-station.svg',
  FTS: 'assets/svg/shopfloor/shared/agv-vehicle.svg',
  HBW_SQUARE1: 'assets/svg/shopfloor/systems/factory-system.svg',
  HBW_SQUARE2: 'assets/svg/shopfloor/stations/conveyor-station.svg',
  ...
  'INTERSECTION-4': 'assets/svg/shopfloor/intersections/intersection-4.svg',
  FACTORY_CONFIGURATION: 'assets/svg/ui/heading-factory-configuration.svg',
  SHOPFLOOR_LAYOUT: 'assets/svg/ui/heading-shopfloor-layout.svg',
  PARAMETER_CONFIGURATION: 'assets/svg/ui/heading-modules.svg',
  PRODUCTION_SETTINGS: 'assets/svg/ui/heading-modules.svg',
  CONFIGURATION: 'assets/svg/ui/heading-modules.svg',
