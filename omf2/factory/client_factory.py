    ...
    def _get_default_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "environments": {
                ...
                "replay": {"mqtt": {"host": "localhost", "port": 1883, "username": "", "password": ""}},
                "mock": {"mqtt": {"host": "mock", "port": 0, "username": "", "password": ""}},
            },
        }
            ...
            try:
                ...
                if self._registry_manager:
                    ...
                    if environment:
                        ...
                        logger.info(
                            f"✅ Created MQTT client: {client_name} ({client_class_name}) with environment: {environment}"
                        )
                    else:
