...
class AdminSettings:
    ...
    def load_mqtt_settings(self) -> Dict[str, Any]:
        ...
        try:
            if self.mqtt_settings_file.exists():
                with open(self.mqtt_settings_file, encoding="utf-8") as f:
    ...
    def load_user_roles(self) -> Dict[str, Any]:
        ...
        try:
            if self.user_roles_file.exists():
                with open(self.user_roles_file, encoding="utf-8") as f:
                    return yaml.safe_load(f) or {}
            else:
    ...
    def load_apps_config(self) -> Dict[str, Any]:
        ...
        try:
            if self.apps_file.exists():
                with open(self.apps_file, encoding="utf-8") as f:
                    return yaml.safe_load(f) or {}
            else:
    ...
    def _get_default_user_roles(self) -> Dict[str, Any]:
        ...
        return {
            "roles": {
                "admin": {"name": "Administrator", "permissions": ["*"], "description": "Full system access"},
                "operator": {
                    "name": "Operator",
            ...
            "users": {"admin": {"role": "admin", "name": "System Administrator", "active": True}},
