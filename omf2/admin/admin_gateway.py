...
class AdminGateway:
    ...
    def __init__(self, mqtt_client=None, **kwargs):
        ...
        self.topic_manager = get_admin_topic_manager(registry_manager=self.registry_manager)
    ...
    def publish_message(self, topic: str, message: Dict[str, Any], qos: int = None, retain: bool = None) -> bool:
        ...
        try:
            ...
            success = self.mqtt_client.publish_message(topic=topic, message=message, qos=qos, retain=retain)
    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            status = {
                ...
                "schemas_count": (
                    len(self.registry_manager.get_schemas()) if hasattr(self.registry_manager, "get_schemas") else 0
                ),
    ...
    def get_connection_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"connected": False, "client_id": "error", "environment": "error"}
