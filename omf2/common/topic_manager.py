...
class TopicManager:
    ...
    def get_all_topics(self) -> List[str]:
        ...
        try:
            ...
            for topic, _topic_info in topics_data.items():
    ...
    def get_published_topics(self, domain: str = None) -> List[str]:
        ...
        try:
            ...
            logger.debug(
                f"📊 [{self.domain}] Retrieved {len(published_topics)} published topics for domain: {target_domain}"
            )
    ...
    def get_subscribed_topics(self, domain: str = None) -> List[str]:
        ...
        try:
            ...
            logger.debug(
                f"📊 [{self.domain}] Retrieved {len(subscribed_topics)} subscribed topics for domain: {target_domain}"
            )
    ...
    def validate_topic_structure(self, topic: str) -> Dict[str, Any]:
        ...
        """
        try:
            validation = {"topic": topic, "valid": True, "errors": [], "warnings": []}
