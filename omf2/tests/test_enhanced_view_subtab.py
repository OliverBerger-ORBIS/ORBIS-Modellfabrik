...
from omf2.ui.admin.message_center.enhanced_view_subtab import render_enhanced_view_subtab
from omf2.ui.utils.message_utils import MessageRow, flatten_messages_for_df


class TestEnhancedViewSubtab(unittest.TestCase):
    """Test für Enhanced View Subtab"""
    
    def setUp(self):
        """Setup für jeden Test"""
        # Mock Streamlit session state
        self.mock_session_state = {
            'admin_mqtt_client': Mock(),
            'admin_gateway': Mock()
        }
    ...
    def test_render_enhanced_view_subtab_basic(self, mock_success, mock_info, mock_columns, mock_markdown, mock_subheader, mock_session_state):
        """Test: Basic rendering der Enhanced View Subtab"""
        ...
        try:
            ...
            self.fail(f"Enhanced View Subtab failed with error: {e}")
    ...
    def test_render_with_mqtt_client_error(self, mock_error, mock_success, mock_info, mock_columns, mock_markdown, mock_subheader, mock_session_state):
        """Test: Enhanced View Subtab mit MQTT Client Fehler"""
        ...
        try:
            ...
            self.fail(f"Enhanced View Subtab should handle MQTT client errors gracefully: {e}")
    ...
    @patch('streamlit.info')
    @patch('streamlit.success')
    def test_render_with_messages(self, mock_success, mock_info, mock_columns, mock_markdown, mock_subheader, mock_session_state):
        """Test: Enhanced View Subtab mit echten Messages"""
        ...
        try:
            ...
            self.fail(f"Enhanced View Subtab failed with messages: {e}")
