...
class TestRegistryMigration(unittest.TestCase):
    ...
    def test_schemas_loaded_correctly(self):
        ...
        expected_schemas = ["ccu_global.schema", "module_v1_ff_serial_connection.schema", "j1_txt_1_i_bme680.schema"]
    ...
    def test_registry_files_exist(self):
        ...
        expected_files = ["modules.yml", "mqtt_clients.yml", "stations.yml", "txt_controllers.yml", "workpieces.yml"]
