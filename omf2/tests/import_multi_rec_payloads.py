    ...
    def import_single_file(self, source_file: Path, session: str = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if payload_content is None:
                return {"success": False, "reason": "No valid payload found", "target_file": None, "topic": topic}
            ...
            return {"success": True, "reason": None, "target_file": target_filename, "topic": topic}

        except Exception as e:
            return {"success": False, "reason": f"Error processing file: {e}", "target_file": None, "topic": None}
