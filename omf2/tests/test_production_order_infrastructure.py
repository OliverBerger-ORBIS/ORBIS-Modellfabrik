...
def test_active_order_message_processing():
    ...
    try:
        ...
        # Message verarbeiten
        manager.process_active_order_message(
            topic="ccu/order/active",
            message=test_active_message,
            meta={"timestamp": "2025-10-08T10:00:00Z"}
        )
...
def test_completed_order_message_processing():
    ...
    try:
        ...
        # Message verarbeiten
        manager.process_completed_order_message(
            topic="ccu/order/completed",
            message=test_completed_message,
            meta={"timestamp": "2025-10-08T11:00:00Z"}
        )
