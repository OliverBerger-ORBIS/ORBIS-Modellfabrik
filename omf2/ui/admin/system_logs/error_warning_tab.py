...
def render_error_warning_tab():
    ...
    try:
        ...
        error_tab, warning_tab = st.tabs(
            [i18n.t("admin.error_warning.errors_tab"), i18n.t("admin.error_warning.warnings_tab")]
        )
    ...
    for i, log_entry in enumerate(logs):
        ...
        with st.container():
            ...
            with col4:
                ...
                truncated_message = (
                    parsed_log["message"][:50] + "..." if len(parsed_log["message"]) > 50 else parsed_log["message"]
                )
