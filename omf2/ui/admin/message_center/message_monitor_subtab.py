    ...
    try:
        ...
        with col1:
            ...
            message_type_filter = st.selectbox(
                "📨 Nachrichten-Typ", options=["Alle", "received", "sent"], index=0, key="enhanced_message_type_filter"
            )
        ...
        with col2:
            ...
            category_filter = st.selectbox(
                "🏷️ Topic-Kategorie", options=topic_categories, index=0, key="enhanced_category_filter"
            )
                ...
                if buffer_data and len(buffer_data) > 0:
                    ...
                    for message in buffer_data:
                        message_row = MessageRow(
                            ...
                            ),  # Default to 'received' for normal messages
        ...
        try:
            ...
            if topic_pattern_filter:
                filtered_messages = [
                    msg for msg in filtered_messages if topic_pattern_filter.lower() in msg.topic.lower()
                ]
        except Exception as e:
        ...
        if filtered_messages:
            ...
            st.dataframe(
                ...
                column_config={
                    ...
                    f"{UISymbols.get_functional_icon('topic_driven')}": st.column_config.TextColumn(
                        "Topic", width="medium"
                    ),
