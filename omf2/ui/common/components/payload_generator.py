...
class PayloadGenerator:
    ...
    def _generate_payload_from_schema(self, schema: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not properties and schema.get("additionalProperties", False):
            ...
            return {"message": "test_message", "timestamp": "2024-01-01T00:00:00Z", "data": {}}
    ...
    def _generate_property_value(self, prop: str, prop_info: Dict[str, Any]) -> Any:
        ...
        if prop == "orderUpdateId":
            ...
            result["agvActions"] = [{"actionType": "test_action", "actionScopes": "test_scope"}]
            ...
            result["moduleParameters"] = {"clearModuleOnPick": True}
            ...
            return {
                "loadSets": [{"setName": "test_load_set", "loadType": "WHITE", "maxAmount": 1}],
                "loadPositions": ["A1", "A2"],
            }
