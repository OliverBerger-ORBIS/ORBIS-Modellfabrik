...
class TopicSelector:
    ...
    def render_schema_driven_ui(self):
        ...
        try:
            ...
            if selected_schema:
                self._render_schema_details_with_topics(selected_schema, schema_to_topics[selected_schema], topics_with_schemas)
        ...
        try:
            ...
            if related_topics:
                ...
                selected_topic = st.selectbox(
                    "Select Topic:",
                    related_topics,
                    key=f"schema_topic_select_{schema_name}"
                )
    ...
    def _schema_matches(self, topic_schema: Any, target_schema_name: str) -> bool:
        ...
        try:
            if isinstance(topic_schema, dict):
                ...
                return (target_schema_name in schema_id or 
                        target_schema_name in schema_title or 
                        target_schema_name in schema_name)
            else:
