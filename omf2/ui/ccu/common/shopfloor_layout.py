...
def _display_fixed_aspect_ratio_grid(
    grid_array, rows, columns, active_module_id: str, active_intersections: list, asset_manager
):
    ...
    for row in range(rows):
        for col in range(columns):
            ...
            # Generate cell HTML
            cell_html = _generate_grid_cell_html(
                cell, row, col, active_module_id, active_intersections, asset_manager, int(cell_size)
            )
...
def _generate_grid_cell_html(
    cell, row, col, active_module_id: str, active_intersections: list, asset_manager, cell_size: int
):
    ...
    if cell_type == "module":
        ...
        return asset_manager.get_shopfloor_module_html(
            intersection_id, intersection_id, is_intersection_active, size=cell_size
        )
