...
def render_nodered_processes_tab():
    ...
    try:
        ...
        with st.expander(f"{UISymbols.get_functional_icon('process_management')} Process Management", expanded=True):
            ...
            processes = [
                {"id": "PROC-001", "name": "OPC-UA Data Collection", "status": "running", "progress": 75, "type": "Data Collection"},
                {"id": "PROC-002", "name": "MQTT Message Normalization", "status": "running", "progress": 45, "type": "Message Processing"},
                {"id": "PROC-003", "name": "Status Aggregation", "status": "waiting", "progress": 0, "type": "Data Processing"},
                {"id": "PROC-004", "name": "Error Handling", "status": "idle", "progress": 0, "type": "Error Management"},
            ]
        ...
        with st.expander("🎛️ Process Control", expanded=True):
            ...
            # Process selection
            process_names = ["OPC-UA Data Collection", "MQTT Message Normalization", "Status Aggregation", "Error Handling"]
        ...
        with st.expander("📊 Process Monitoring", expanded=True):
            ...
            # Performance data
            performance = [
                {"process": "OPC-UA Data Collection", "cpu": "45%", "memory": "67%", "throughput": "234/min", "errors": 0},
                {"process": "MQTT Message Normalization", "cpu": "38%", "memory": "52%", "throughput": "189/min", "errors": 1},
        ...
        with st.expander("⚙️ Process Configuration", expanded=False):
            ...
            with col1:
                ...
                st.selectbox("Log Level:", ["DEBUG", "INFO", "WARNING", "ERROR"], index=1, key="nodered_processes_log_level")
