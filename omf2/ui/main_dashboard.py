...
class MainDashboard:
    ...
    def _handle_environment_switch(self, old_env, new_env):
        ...
        logger.info("🔄 ENV-SWITCH: Cache geleert, Environment aktualisiert")
    ...
    def _reconnect_logging_system(self):
        ...
        try:
            ...
            if success:
                logger.info("✅ Logging system reconnected successfully - Handler verified at root logger")
            else:
                logger.error("❌ FEHLER: Handler attachment verification failed after reconnect")
