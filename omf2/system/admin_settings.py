...
class AdminSettings:
    ...
    def _get_default_apps_config(self) -> Dict[str, Any]:
        ...
        return {
            "apps": {
                ...
                "message_center": {
                    "name": "Message Center",
                    "description": "Central message and notification center",
                    "enabled": True,
                    "module": "omf2.ui.system.message_center_tab"
                },
                "system_logs": {
                    "name": "System Logs",
    ...
    def get_user_permissions(self, username: str) -> List[str]:
        ...
        role_name = user_info.get("role", user_roles.get("default_role", "viewer"))
