...
class WorkpieceManager:
    ...
    def reload_config(self) -> bool:
        ...
        try:
            ...
            if self.workpieces_file.exists():
                with open(self.workpieces_file, encoding="utf-8") as f:
    ...
    def get_workpiece_by_nfc_code(self, nfc_code: str) -> Optional[Dict[str, Any]]:
        ...
        for _workpiece_id, workpiece_data in workpieces.items():
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        stats = {"total_workpieces": len(workpieces), "colors": {}, "types": {}, "total_nfc_codes": 0}
